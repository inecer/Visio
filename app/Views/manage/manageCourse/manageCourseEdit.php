...
<?php $this->start('manageCourseEdit_content') ?>
    <div class="p-56 min-h-screen flex justify-center bg-gray-700">
        <div class="bg-white p-8 rounded shadow-2xl w-2/3">
            <!--Nav-Bar-->
            <form action="<?=$this->url("manageCourse_mngCourseUpdate").$id?>" method="post">


                <!--HTML-->
                <div class="html" id="firstPart">
                    <h2 class="text-4xl font-bold mb-10 text-gray-800">Modifier : <?=$this->e($course['title'])?></h2>
                    <label class="block mb-1 font-bold text-gray-700" for="title">Titre</label><input class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-indigo-500" type="text" value="<?=$this->e($course['title'])?>" name="title">
                    <label class="block mb-1 font-bold text-gray-700" for="description">Description</label><input class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-indigo-500" type="text" value="<?=$this->e($course['description'])?>" name="description">
                    <br>
                    <br>
...
<?php $this->stop('manageCourseEdit_content') ?>