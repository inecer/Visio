...
<?php $this->start('managePictureServerAdd_content') ?>
    <div>
        <form action="<?=$this->url("managePicture_mngPictureInsert")?>" method="post">
            <div class="p-56 min-h-screen flex justify-center bg-gray-700">
                ...
                <div class="bg-white p-8 rounded shadow-2xl w-2/3">
                    ...
                    <div>
                        ...
                        <input class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-indigo-500" placeholder="Entrez un titre..." name="title" type="text">
                    </div>
                    <br>
                    <div>
                        <label class="block mb-1 font-bold text-gray-700">Description :</label>
                        <input class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-indigo-500" placeholder="Entrez une description..." name="description" type="text">
                    </div>
                    <br>
                    <div>
                    ...
                    <br>
                    <div>
                        <label class="block mb-1 font-bold text-gray-700">Image :</label>
                        <img src="https://crsonline.biomedicale.parisdescartes.fr/visio/assets/dzi/<?=$this->e($dzi['dzi'])?>/file_files/8/0_0.jpeg" name="url" "/>
                    </div>
                    <br>
                    <input type="hidden" value="<?=$this->e($dzi['dzi'])?>" name="dzi">
                    <input type="hidden" value="<?=$this->e($dzi['url'])?>" name="url">
                    <div class="space-y-6">
...
<?php $this->stop('managePictureServerAdd_content') ?>